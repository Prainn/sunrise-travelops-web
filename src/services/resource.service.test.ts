...
const transport: TransportRecord = { ...audit, id: "transport-1", code: "VEH-001", name: "Vehicle", serviceLevel: "standard", plateNumber: "云A00001", seats: 7, dailyPrice: 800, unit: "vehicleDay", city: "昆明", countryOrRegion: "", contact: "赵师傅", email: "", phone: "13800000000", status: "enabled", remark: "" };
