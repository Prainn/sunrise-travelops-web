...
export interface LogQuery { businessUnit?: "shengxu" | "linxi" | "website"; page: number; pageSize: number; inquiryId?: string; inquiryCode?: string; operatorId?: string; action?: InquiryLogAction | ""; from?: string; to?: string }
