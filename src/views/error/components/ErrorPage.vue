<template>
  <section class="error-page">
    <div
      class="error-page__inner grid [grid-template-columns:minmax(0,_0.88fr)_minmax(360px,_1fr)] gap-[56px] items-center w-[min(1040px,_100%)]"
    >
      <div class="error-page__content min-w-0">
        <div
          class="error-page__label inline-flex items-center h-[28px] p-[0_10px] mb-[18px] text-[14px] font-medium text-[var(--el-color-primary)] [background:var(--el-color-primary-light-9)] [border:1px_solid_var(--el-color-primary-light-8)] rounded-[6px]"
        >
          {{ label }}
        </div>
        <h1
          class="error-page__code m-0 text-[112px] font-bold leading-[0.9] text-[var(--el-color-primary)] [letter-spacing:0]"
        >
          {{ statusCode }}
        </h1>
        <h2
          class="error-page__title m-[28px_0_0] text-[26px] font-semibold leading-[1.35] text-[var(--el-text-color-primary)] [letter-spacing:0]"
        >
          {{ title }}
        </h2>
        <p
          class="error-page__description max-w-[440px] m-[12px_0_0] text-[16px] leading-[1.8] text-[var(--el-text-color-secondary)]"
        >
          {{ description }}
        </p>
      ...
      <div class="error-page__visual flex justify-center min-w-0" aria-hidden="true">
        <div class="error-visual">
          ...
          <div class="error-visual__body p-[28px]">
            <div class="error-visual__summary flex gap-[16px] items-center">
              <div
                class="error-visual__icon grid place-items-center w-[68px] h-[68px] text-[var(--el-color-primary)] [background:var(--el-color-primary-light-9)] [border:1px_solid_var(--el-color-primary-light-8)] rounded-[8px]"
              >
                <el-icon :size="34">
              ...
              <div>
                <div
                  class="error-visual__status text-[34px] font-bold leading-[1] text-[var(--el-text-color-primary)] [letter-spacing:0]"
                >
                  {{ statusCode }}
                </div>
                <div
                  class="error-visual__name mt-[8px] text-[14px] font-medium text-[var(--el-text-color-secondary)] [letter-spacing:0]"
                >
                  {{ visualName }}
                </div>
              </div>
            ...
            <svg class="error-visual__route block w-full h-auto mt-[28px]" viewBox="0 0 360 136">
              <path
