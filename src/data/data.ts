...
export const inquiries: InquiryRecord[] = [
  ...
  {
    id: "inquiry-12", code: "INQ-202608-012", agencyId: "agency-1", agencyCode: "AGY-001", agencyName: "新加坡远景旅行社",
    contactName: "Emily Tan", email: "emily@example.com", phone: "+65 6123 4567", countryOrRegion: "新加坡",
    sourceChannel: "Email", originalMessage: "6 人银发小团希望 11 月安排昆明、弥勒温泉和建水 6 天游，行程节奏不要太紧。",
    internalRemark: "需确认是否需要轮椅及无障碍房。", owner: "王敏", operationsCoordinator: "张伟", nextFollowUpAt: "2026-09-02 14:00", plannedDays: 6,
    lostReason: "", status: "new", creator: "inquiry", createdAt: "2026-08-30 11:05",
  },
  {
    id: "inquiry-13", code: "INQ-202608-013", agencyId: "agency-2", agencyCode: "AGY-002", agencyName: "Malaysia Star Holidays",
    contactName: "Jason Lee", email: "jason@example.com", phone: "+60 3-1234 5678", countryOrRegion: "马来西亚",
    sourceChannel: "WhatsApp", originalMessage: "14 人摄影团计划 12 月前往元阳梯田、建水古城和东川红土地，预计 8 天。",
    internalRemark: "摄影团需要日出日落机位、充足行李空间和早出餐盒。", owner: "李娜", operationsCoordinator: "陈晨", nextFollowUpAt: "2026-09-03 09:30", plannedDays: 8,
    lostReason: "", status: "new", creator: "inquiry_lina", createdAt: "2026-08-30 14:40",
  },
  {
    id: "inquiry-14", code: "INQ-202608-014", agencyId: "agency-3", agencyCode: "AGY-003", agencyName: "Bangkok Discovery Travel",
    contactName: "Narin Chai", email: "narin@example.com", phone: "+66 2-123-4567", countryOrRegion: "泰国",
    sourceChannel: "Website", originalMessage: "4 人希望国庆期间安排丽江、香格里拉 5 天游，并入住雪山景观酒店。",
    internalRemark: "已提供旺季价格说明。", owner: "王敏", operationsCoordinator: "赵磊", nextFollowUpAt: "", plannedDays: 5,
    lostReason: "客户无法调整国庆出行日期，预算不足", status: "lost", creator: "inquiry", createdAt: "2026-08-29 16:10",
  },
  {
    id: "inquiry-15", code: "INQ-202608-015", agencyId: "agency-5", agencyCode: "AGY-005", agencyName: "Seoul Hanul Travel",
    contactName: "Min-jun Park", email: "minjun@example.com", phone: "+82 2-555-0105", countryOrRegion: "韩国",
    sourceChannel: "Referral", originalMessage: "16 人企业团希望安排昆明、大理 5 天游，包含一晚欢迎宴和一场团队交流活动。",
    internalRemark: "需要韩文导游、会议场地和独立用餐包间。", owner: "李娜", operationsCoordinator: "陈晨", nextFollowUpAt: "2026-09-01 16:00", plannedDays: 5,
    ...
    dailyPlans: [
      {
        ...
        items: [
          { id: "item-1", type: "vehicle", resourceId: "transport-1", resourcePriceId: "transport-1-daily", resourceName: "别克 GL8", priceName: "车辆日成本", providerName: "直营报价", quantity: 1, unit: "vehicleDay", unitCost: 1200, totalCost: 1200, remark: "接机及市内用车" },
          { id: "item-2", type: "hotel", resourceId: "hotel-1", resourcePriceId: "price-1", resourceName: "盘龙温德姆花园", priceName: "城景大床/双床房 · 常规期", providerName: "直营报价", quantity: 3, unit: "roomNight", unitCost: 400, totalCost: 1200, remark: "3 间双床房" },
        ],
      },
      {
        ...
        items: [
          { id: "item-3", type: "attraction", resourceId: "attraction-2", resourcePriceId: "attraction-price-5", resourceName: "崇圣寺三塔", priceName: "景区门票 · 成人 · 常规期", providerName: "直营报价", quantity: 6, unit: "personVisit", unitCost: 60, totalCost: 360, remark: "成人票" },
          { id: "item-4", type: "restaurant", resourceId: "restaurant-5", resourcePriceId: "restaurant-price-20", resourceName: "大理六合云燕酒店", priceName: "中式合菜/清新养生宴", providerName: "直营报价", quantity: 1, unit: "table", unitCost: 500, totalCost: 500, remark: "晚餐" },
        ],
      },
...
export const inquiryLogs: InquiryLogRecord[] = [
  ...
  },
  {
    ...
    metadata: { lostReason: "客户无法调整国庆出行日期，预算不足" },
  },
  {
